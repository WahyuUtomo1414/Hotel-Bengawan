<div class="sidebar-wrapper">
	...
	<div class="version">Begawan hotel</div>
	<ul class="left-navbar">
		...
		{{-- <li class="dropdown"><a class="nav-link" href="{{route('backend.theme-options')}}"><i class="fa fa-wrench"></i>{{ __('Theme Options') }}</a> --}}
			{{-- <ul class="dropdown-menu">
				<li><a href="{{ route('backend.menu') }}">{{ __('Menu') }}</a></li>
				<li><a href="{{  }}">{{ __('Theme Options') }}</a></li>
			</ul> --}}
		</li>
