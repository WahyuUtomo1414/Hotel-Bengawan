			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.our_services_table')
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="services_title">{{ __('Title') }}<span class="red">*</span></label>
										<input type="text" name="services_title" id="services_title" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
							</div>
							<div class="row">	
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="services_image">{{ __('Image') }}<span class="red">*</span></label>
										<div class="tp-upload-field">
											<input type="text" name="image" id="services_image" class="form-control" readonly>
											<a id="on_services_image" href="javascript:void(0);" class="tp-upload-btn"><i class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
										</div>
										<em>Recommended image size width: 100px and height: 100px.</em>
										<div id="remove_services_image" class="select-image">
											<div class="inner-image" id="view_services_image"></div>
											<a onClick="onMediaImageRemove('services_image')" class="media-image-remove" href="javascript:void(0);"><i class="fa fa-remove"></i></a>
										</div>
									</div>
								</div>
...
<script src="{{asset('backend/pages/our_services.js')}}"></script>
