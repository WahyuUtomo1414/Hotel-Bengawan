						...
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							...
							<div class="row mt-25">
								<div class="col-lg-12">
									...
									<a href="{{ route('receptionist.all-booking') }}" class="btn warning-btn"><i class="fa fa-reply"></i> {{ __('Back to List') }}</a>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div id="tp_datalist_modal">
								@include('receptionist.partials.room_list_for_assign_room')
							</div>
						</div>
					</div>
				</div>
...
<script src="{{asset('backend/pages/receptionist_booking.js')}}"></script>
@endpush